...
public class PostEmail {
    // 发送邮件的账号
    public static String ownEmailAccount = "674683729@qq.com";
    // 发送邮件的密码------》授权码
    public static String ownEmailPassword = "darkqnxngrhdbcda";
    // 发送邮件的smtp 服务器 地址
    public static String myEmailSMTPHost = "smtp.qq.com";
    // 发送邮件对方的邮箱 于老大
    public static String receiveMailAccount = "1491098921@qq.com";
    ...
    public static Message createSimpleMail(Session session) throws Exception {
        ...
        message.setFrom(new InternetAddress(ownEmailAccount, "高远航", "utf-8"));
        // 代表收件人
        ...
        // 设置邮件主题
        message.setSubject("枣庄牛逼");
        // 设置邮件内容
        message.setContent("<h1>神级无敌疯子</h1>", "text/html;charset=utf-8");
        // 设置发送时间
